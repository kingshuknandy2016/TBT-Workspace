...
//================================================================================================================
/*Test-18:Select the "90" option in the Item per Page
*Expected Results:System displays only 90 items per page when user selects "90" option.
* */
//================================================================================================================
public class Case18 {
	
	public static String url="http://www.beallsflorida.com/";
	public static String ExpectedResult="Items Per Page is 90";
	...
	public static void main(String[] args) {
	    ...
	    try{
	    NoofPage=driver.findElement(By.xpath("//span[contains(text(),'90')]"));
	    
	    }catch(Exception e1){
	    	
	    NoofPage=driver.findElement(By.xpath("//a[contains(text(),'90')]"));
	    NoofPage.click();
