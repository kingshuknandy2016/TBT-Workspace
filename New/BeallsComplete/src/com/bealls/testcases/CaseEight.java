...
//			 System.out.println(tlist.get(i)+"\t\t\t"+titemsPerPage.get(i));
		 ...
		 if(!Ordering.natural().isOrdered(titemsPerPage))
			System.out.println("The items are not in order of Highest ratings in page "+lowerLimit);
		 else
			System.out.println("The items are in order of Highest ratings in page "+lowerLimit);
...
//		 System.out.println("Displayed "+itemsPerPage+" in page "+lowerLimit);
        ...
        System.out.println("All items are not in order of Highest ratings");
        else
        System.out.println("All items are in order of Highest ratings");
