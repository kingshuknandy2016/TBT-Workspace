...
public class TC4_BeallsFlorida_ShoppingCart {
	...
	public TC4_BeallsFlorida_ShoppingCart ()throws Exception{
		sel=Main.sellaunch;
//		xp = Main.xpath;	
	}
     
     public void TC4_BeallsFlorida_ShoppingCart()throws Exception{
    	 try
 		{	
    	 System.out.println("*******----- TC4_BeallsFlorida_ShoppingCart -----*******");	
    	Genericscripts gs = new Genericscripts(getClass().getSimpleName());
    	sel.windowMaximize();
